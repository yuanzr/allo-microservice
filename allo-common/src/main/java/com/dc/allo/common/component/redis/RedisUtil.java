package com.dc.allo.common.component.redis;

import com.dc.allo.common.utils.JsonUtils;
import com.dc.allo.common.utils.ProtoStuffSerializerUtil;
...
public class RedisUtil {
    ...
    /**
     * 加锁 设置指定 key 的值,带过期时间<p></p>
     * 如果存在则不设置 返回false<p></p>
     * 如果不存在则设置 返回true
     */
    public Boolean addlockByDontWait(String key,String value,long seconds){
        return stringRedisTemplate.opsForValue().setIfAbsent(key,value,seconds,TimeUnit.SECONDS);
    }

    public Boolean addLock(String key,String value,int waitTime,long seconds){
        int retryTime = waitTime;
        try {
            while (retryTime > 0) {
                if (stringRedisTemplate.opsForValue().setIfAbsent(key,value,seconds,TimeUnit.SECONDS)) {
                    return true;
                }
                retryTime -= 10;
                Thread.sleep(10);
            ...
            log.error("lock error, lockKey:{}, waitTime:{}, timeout:{}",key,waitTime,seconds,e);
        }
        return false;
    }
    ...
    /**
     *  解锁 如果锁存在则value相等则删除锁
     */
    public void delLock(String key,String value){
        String currLockVal = stringRedisTemplate.opsForValue().get(key);
        if (currLockVal != null && currLockVal.equals(value)) {
            stringRedisTemplate.delete(key);
        }
    }
    ...
     * @param seconds
     * @author qinrenchuan
     * @date 2020/4/29/0029 17:02
     */
    public void multiSet(Map<String, String> maps, long seconds) {
        ...
        stringRedisTemplate.execute(new RedisCallback<Object>() {
            ...
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                ...
                for (Entry<String, String> entry : entries) {
                    connection.setEx(entry.getKey().getBytes(),
                            seconds + RedisKeyUtil.getRandomOffset(seconds),
    ...
    public void hPutByPipe(String key,Map<String,String> keyValueMap){
        ...
        stringRedisTemplate.executePipelined(new SessionCallback() {
            ...
            public Object execute(RedisOperations operations) throws DataAccessException {
                keyValueMap.keySet().stream().forEach(hashKey->{
                    operations.opsForHash().put(key,hashKey,keyValueMap.get(hashKey));
                });
                return null;
            }
        });
     ...
     * @return void
     * @author qinrenchuan
     * @date 2020/5/8/0008 19:22
     */
    public void hPutAll(String key, Map<String, String> maps, long seconds) {
        stringRedisTemplate.execute(new RedisCallback<Object>() {
            @Override
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                ...
                connection.expire(key.getBytes(), seconds + RedisKeyUtil.getRandomOffset(seconds));
                return null;
            }
        });
    }
